				...
				<div class="postbox">
					...
					<div class="inside">
						<div id="hDefaultset" class="idMoreinfofull">
							<?php _e('This is where you set the defaults for whenever you create a new project on your website.  Whatever you set here, is what each project will default to, unless oyu set its custom settings below.', 'ignitiondeck'); ?><br><br>
