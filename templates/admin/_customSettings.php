		...
		<div class="metabox-holder">
			<div class="meta-box-sortables" style="min-height:0;">
				<div class="postbox">
					...
					<h3 class="hndle"><a href="#" class="back">&lt; <?php echo $tr_Back; ?></a>&nbsp;<span><?php echo stripslashes($products->product_name); ?></span></h3>
					<div class="inside">
					...
					<div class="inside">
						...
						<table width="100%" border="0">
							<tr>
								<td width="20%"><?php echo $tr_Product_Name; ?></td>
								<td width="5%"><?php echo $tr_Product_ID; ?></td>
							...
							foreach ($products as $product) {
								?>
							<tr>
								<td width="30%"><a href="?page=custom-settings&amp;pid=<?php echo $product->id ?>"><?php echo stripslashes($product->product_name); ?></a></td>
